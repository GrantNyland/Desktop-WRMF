object MineUndergroundQSLDDlg: TMineUndergroundQSLDDlg
  Left = 468
  Top = 167
  BorderIcons = []
  BorderStyle = bsNone
  Caption = 'Underground Q vs SLD'
  ClientHeight = 396
  ClientWidth = 526
  Color = clBtnFace
  ...
  object ScrClient: TScrollBox
    ...
    BevelOuter = bvNone
    TabOrder = 0
    object LblStdDevUnderground: TLabel
      Left = 10
      Top = 10
      Width = 100
      Height = 21
    ...
    object GrdUndergroundQSLD: TWRMFGrid
      Left = 10
      Top = 40
      Width = 183
      Height = 290
    ...
    object EdtStdDevUnderground: TWRMFEdit
      Left = 120
      Top = 10
      Width = 70
      Height = 21
      ...
      OnExit = ControlExit
      Active = True
      PropertyName = 'StdDevUnderground'
      HasParamChange = False
      HasMetaData = False
      IsValid = True
    end
