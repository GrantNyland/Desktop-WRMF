...
//
//
//  UNIT      : Contains the class TOutputMonthlyDeficitDialog.
...
unit UOutputMonthlyDeficitDialog;
...
type
  ...
  TOutputMonthlyDeficitDialog = class(TAbstractScrollablePanel)
  protected
...
{ TOutputMonthlyDeficitDialog }

procedure TOutputMonthlyDeficitDialog.CreateMemberObjects;
const OPNAME = 'TOutputMonthlyDeficitDialog.CreateMemberObjects';
begin
...
function TOutputMonthlyDeficitDialog.Initialise: boolean;
const OPNAME = 'TOutputMonthlyDeficitDialog.Initialise';
begin
...
function TOutputMonthlyDeficitDialog.StudyHasChanged: boolean;
const OPNAME = 'TOutputMonthlyDeficitDialog.StudyHasChanged';
begin
...
function TOutputMonthlyDeficitDialog.LanguageHasChanged: boolean;
const OPNAME = 'TOutputMonthlyDeficitDialog.LanguageHasChanged';
begin
...
procedure TOutputMonthlyDeficitDialog.Resize;
const OPNAME = 'TOutputMonthlyDeficitDialog.Resize';
begin
  try
...
procedure TOutputMonthlyDeficitDialog.DestroyMemberObjects;
const OPNAME = 'TOutputMonthlyDeficitDialog.DestroyMemberObjects';
begin
  try
...
function TOutputMonthlyDeficitDialog.CreateBoxPlotSeries: TBoxSeries;
const OPNAME = 'TOutputMonthlyDeficitDialog.CreateBoxPlotSeries';
begin
  Result := nil;
  try
