...
type
  TYRCModelMenuAction = (meValidateFiles, meLoadModelDataFromFiles, meSaveModelDataToDB,
                           meLoadModelDataFromDB, meSaveModelDataToFiles, meCompareFiles,
                           fsApplySelection,meDisableModelMenus);

  TYRCModelMenuData = class(TObject)
  public
    Action: TYRCModelMenuAction;
    constructor Create(AAction: TYRCModelMenuAction);
  end;

  TAbstractYRCModelLinkClass = class(TObject)
  public
    constructor Create;
    procedure Reset;virtual;abstract;
  end;

  {TFileName = class(TAbstractYRCModelLinkClass)
  protected
    FDefaultName: string;
    FCurrentPath: string;
    FCurrentName: string;
...
{ TAbstractYRCModelLinkClass }

constructor TAbstractYRCModelLinkClass.Create;
const OPNAME = 'TAbstractYRCModelLinkClass.Create';
begin
  inherited Create;
  try
    Reset;
...
constructor TYRCModelMenuData.Create(AAction: TYRCModelMenuAction);
const OPNAME = 'TYRCModelMenuData.Create';
begin
  try
    inherited Create;
    Action := AAction;
