...
uses
    Windows, Messages, SysUtils, vcl.Forms;
...
function HtmlHelp(hwndCaller: THandle; pszFile: PAnsiChar;
...
function TconHTMLHelp.ApplicationHelp(Command: Word; Data: THelpEventData;
    var CallHelp: Boolean): Boolean;
...
begin
    ...
    {call HTML Help API}
    HtmlHelp(0, PAnsiChar(AnsiString(Application.HelpFile)),HCommand, Data);
