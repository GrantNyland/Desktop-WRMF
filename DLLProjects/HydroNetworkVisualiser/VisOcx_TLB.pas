...
// PASTLWTR : 1.2
// File generated on 3/1/2005 3:27:35 PM from Type Library described below.

// ************************************************************************  //
// Type Lib: C:\Program Files\Microsoft Office\Visio11\VISOCX.DLL (1)
// LIBID: {F1A8DFE4-BC61-48BA-AFDA-96DF10247AF0}
// LCID: 0
// Helpfile: 
// HelpString: Microsoft Visio 11.0 Drawing Control Type Library
// DepndLst: 
//   (1) v2.0 stdole, (C:\WINDOWS\system32\stdole2.tlb)
//   (2) v4.11 Visio, (C:\Program Files\Microsoft Office\Visio11\VISLIB.DLL)
// ************************************************************************ //
...
// Help String      : Microsoft Visio 11.0 Drawing Control
...
const OPNAME = 'TDrawingControl.InitControlData';
const
  CEventDispIDs: array [0..54] of DWORD = (
...
begin
  ...
  TControlData2(CControlData).FirstEventOfs := Cardinal(@@FOnDocumentOpened) - Cardinal(Self);
end;

procedure TDrawingControl.CreateControl;
const OPNAME = 'TDrawingControl.CreateControl';
  procedure DoCreate;
  const OPNAME = 'VisOcx_TLB.DoCreate';
  begin
...
const OPNAME = 'TDrawingControl.GetControlInterface';
begin
  CreateControl;
  Result := FIntf;
end;
...
const OPNAME = 'TDrawingControl.Get_Document';
begin
    Result := DefaultInterface.Document;
end;

function TDrawingControl.Get_Window: IVWindow;
const OPNAME = 'TDrawingControl.Get_Window';
begin
    Result := DefaultInterface.Window;
end;

procedure Register;
const OPNAME = 'VisOcx_TLB.Register';
begin
