object MineUndergroundRechargeFactorsDlg: TMineUndergroundRechargeFactorsDlg
  Left = 445
  Top = 167
  BorderIcons = []
  BorderStyle = bsNone
  ...
  object ScrClient: TScrollBox
    ...
    object GrdRechargeFactors: TWRMFGrid
      ...
      CellsInfo = <
        ...
        item
          PropertyName = 'BoardAndPillarRechargeFactor'
          HasParamChange = False
          HasMetaData = False
          IsValid = True
          Row = 0
        ...
        item
          PropertyName = 'HighExtractionRechargeFactor'
          HasParamChange = False
          HasMetaData = False
          IsValid = True
          Row = 0
