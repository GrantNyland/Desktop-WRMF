...
type
  ...
  TfrmRunConfiguration = class(TFrame)
    gbRoof: TGroupBox;
    lblRoofArea: TLabel;
...
var
  frmRunConfiguration : TfrmRunConfiguration;
...
{ TfrmRunConfiguration }

procedure TfrmRunConfiguration.AfterConstruction;
const OPNAME = 'TfrmRunConfiguration.AfterConstruction';
begin
  inherited;
  try
    FEditRunConfig    := nil;
...
procedure TfrmRunConfiguration.BeforeDestruction;
const OPNAME = 'TfrmRunConfiguration.AfterConstruction';
begin
  inherited;
  try
...
procedure TfrmRunConfiguration.SetAppModules(AAppModules: TAppModules);
const OPNAME = 'TfrmRunConfiguration.SetAppModules';
begin
  try
...
function TfrmRunConfiguration.Initialise: boolean;
const OPNAME = 'TfrmRunConfiguration.Initialise';
begin
  Result := False;
  try
...
function TfrmRunConfiguration.Finalise: boolean;
const OPNAME = 'TfrmRunConfiguration.Finalise';
begin
  Result := False;
  try
    Result := True;
...
function TfrmRunConfiguration.LanguageHasChanged: boolean;
const OPNAME = 'TfrmRunConfiguration.LanguageHasChanged';
begin
  Result := False;
  try
   Result := True;
...
procedure TfrmRunConfiguration.ClearDialog;
const OPNAME = 'TfrmRunConfiguration.ClearDialog';
{var
  LIndex : integer;}
begin
  try
...
procedure TfrmRunConfiguration.PopulateDialog;
const OPNAME = 'TfrmRunConfiguration.PopulateDialog';
var
  LTankCount : integer;
  LMultiplier : double;
begin
...
procedure TfrmRunConfiguration.PopulateObject;
const OPNAME = 'TfrmRunConfiguration.PopulateObject';
var
  LMultiplier : double;
  LTankCount  : integer;
begin
...
procedure TfrmRunConfiguration.SetButtonState;
const OPNAME = 'TfrmRunConfiguration.SetButtonState';
begin
  try
    ...
    btnSelect.Enabled := btnDelete.Enabled;
    cmboxTankSizes.Enabled   := (StrToIntDef(edtTankCount.Text,0) > 0);
    strgrdTankVolume.Enabled := cmboxTankSizes.Enabled;
  except on E: Exception do HandleError(E, OPNAME) end;
end;

procedure TfrmRunConfiguration.SelectRunConfig(ARunConfig: TRWHRunConfig);
const OPNAME = 'TfrmRunConfiguration.ClearDialog';
begin
  try
...
procedure TfrmRunConfiguration.edtTankCountExit(Sender: TObject);
const OPNAME = 'TfrmRunConfiguration.edtTankCountChange';
var
  LCount,
  LIndex      : integer;
begin
...
procedure TfrmRunConfiguration.strgrdTankVolumeSetEditText(Sender: TObject; ACol, ARow: Integer; const Value: String);
const OPNAME = 'TfrmRunConfiguration.strgrdTankVolumeSetEditText';
begin
  try
    if FPopulating then Exit;
...
procedure TfrmRunConfiguration.cmboxRunTypeChange(Sender: TObject);
const OPNAME = 'TfrmRunConfiguration.cmboxRunTypeChange';
begin
  try
    if FPopulating then Exit;
...
procedure TfrmRunConfiguration.btnNewClick(Sender: TObject);
const OPNAME = 'TfrmRunConfiguration.btnNewClick';
var
  LName : string;
begin
  try
...
procedure TfrmRunConfiguration.btnDeleteClick(Sender: TObject);
const OPNAME = 'TfrmRunConfiguration.btnDeleteClick';
...
procedure TfrmRunConfiguration.btnCopyClick(Sender: TObject);
const OPNAME = 'TfrmRunConfiguration.btnCopyClick';
var
  LName : string;
  LRunConfig       : TRWHRunConfig;
begin
...
procedure TfrmRunConfiguration.btnSaveClick(Sender: TObject);
const OPNAME = 'TfrmRunConfiguration.btnSaveClick';
begin
  try
...
procedure TfrmRunConfiguration.btnSelectClick(Sender: TObject);
const OPNAME = 'TfrmRunConfiguration.btnResetClick';
begin
  try
    if FEditRunConfig.Populated then
    begin
      RWHModelData.SelectedRunConfig := FEditRunConfig;
      lblSelect.Caption := 'Configuration Used in Run: '+FEditRunConfig.RunName;
    end
    else
...
procedure TfrmRunConfiguration.btnResetClick(Sender: TObject);
const OPNAME = 'TfrmRunConfiguration.btnResetClick';
begin
  try
    FEditRunConfig.Changed := False;
...
procedure TfrmRunConfiguration.edtStartingVolumeExit(Sender: TObject);
const OPNAME = 'TfrmRunConfiguration.edtStartingVolumeChange';
var
  LTankCount : integer;
  LMultiplier : double;
begin
...
procedure TfrmRunConfiguration.SetComponentsEnabled(AEnabled: boolean);
const OPNAME = 'TfrmRunConfiguration.SetComponentsEnabled';
begin
  try
    if AEnabled then
    begin
...
procedure TfrmRunConfiguration.cmboxTankSizesExit(Sender: TObject);
const OPNAME = 'TfrmRunConfiguration.cmboxTankSizesExit';
begin
  try
    if FPopulating then Exit;
...
procedure TfrmRunConfiguration.strgrdTankVolumeSelectCell(Sender: TObject;  ACol, ARow: Integer; var CanSelect: Boolean);
const OPNAME = 'TfrmRunConfiguration.strgrdTankVolumeSelectCell';
var
  R: TRect;
begin
  try
