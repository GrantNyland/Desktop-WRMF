object MineUndergroundHighExtractionDlg: TMineUndergroundHighExtractionDlg
  Left = 449
  Top = 169
  BorderIcons = []
  BorderStyle = bsNone
  Caption = 'High extraction area growth'
  ClientHeight = 396
  ClientWidth = 526
  Color = clBtnFace
  ...
  object ScrClient: TScrollBox
    ...
    BevelOuter = bvNone
    TabOrder = 0
    object LblHighExtractionInterpolationOption: TLabel
      Left = 10
      Top = 10
      Width = 90
      Height = 21
    ...
    object GrdHighExtraction: TWRMFGrid
      Left = 10
      Top = 40
      Width = 183
      Height = 290
    ...
    object CbxHighExtractionInterpolationOption: TWRMFComboBox
      Left = 110
      Top = 10
      Width = 100
      Height = 21
      ...
      OnExit = ControlExit
      Active = True
      PropertyName = 'HighExtractionInterpolationOption'
      HasParamChange = False
      HasMetaData = False
      IsValid = True
      ItemIndex = -1
