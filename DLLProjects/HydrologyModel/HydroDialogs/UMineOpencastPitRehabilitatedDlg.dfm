object MineOpencastPitRehabilitatedDlg: TMineOpencastPitRehabilitatedDlg
  Left = 459
  Top = 167
  BorderIcons = []
  BorderStyle = bsNone
  Caption = 'Rehabilitated area growth'
  ClientHeight = 396
  ClientWidth = 526
  Color = clBtnFace
  ...
  object ScrClient: TScrollBox
    ...
    BevelOuter = bvNone
    TabOrder = 0
    object LblRehabilitatedInterpolationType: TLabel
      Left = 10
      Top = 10
      Width = 90
      Height = 21
