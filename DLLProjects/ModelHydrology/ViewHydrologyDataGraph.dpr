library ViewHydrologyDataGraph;
...
uses
  ...
  UAbstractObject,
  UViewGraphManager,
  UViewHydrologyDataGraphManager,
...
begin
  ...
  try
    ...
    pao_Object := TViewDataGraphManager.Create(AAppModules);//TViewHydrologyDataGraphManager.Create(AAppModules);
    Result := True;
