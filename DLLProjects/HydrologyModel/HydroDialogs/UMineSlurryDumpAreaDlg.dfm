object MineSlurryDumpAReaDlg: TMineSlurryDumpAReaDlg
  Left = 457
  Top = 164
  BorderIcons = []
  BorderStyle = bsNone
  Caption = 'Slurry dump area growth'
  ClientHeight = 396
  ClientWidth = 526
  Color = clBtnFace
  ...
  object ScrClient: TScrollBox
    ...
    BevelOuter = bvNone
    TabOrder = 0
    object LblSlurryDumpInterpolationOption: TLabel
      Left = 10
      Top = 10
      Width = 90
      Height = 21
    ...
    object GrdSlurryDumpArea: TWRMFGrid
      Left = 10
      Top = 40
      Width = 183
      Height = 290
    ...
    object CbxSlurryDumpInterpolationOption: TWRMFComboBox
      Left = 110
      Top = 10
      Width = 100
      Height = 21
      ...
      OnExit = ControlExit
      Active = True
      PropertyName = 'SlurryDumpInterpolationOption'
      HasParamChange = False
      HasMetaData = False
      IsValid = True
      ItemIndex = -1
