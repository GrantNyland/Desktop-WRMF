unit UOutputComparisonReservoirValidator;
...
type
  TOutputComparisonReservoirValidator = class(TAbstractOutputDialogValidator)
  protected
    ...
    procedure PopulateReservoirVolumeData(ASeries : integer; AData: TStrings;ASeriesName : string);
...
{ TOutputComparisonReservoirValidator }

procedure TOutputComparisonReservoirValidator.CreateMemberObjects;
const OPNAME = 'TOutputComparisonReservoirValidator.CreateMemberObjects';
begin
  try
...
procedure TOutputComparisonReservoirValidator.DestroyMemberObjects;
const OPNAME = 'TOutputComparisonReservoirValidator.DestroyMemberObjects';
begin
  try
...
function TOutputComparisonReservoirValidator.Initialise: boolean;
const OPNAME = 'TOutputComparisonReservoirValidator.Initialise';
begin
...
function TOutputComparisonReservoirValidator.StudyDataHasChanged(AContext: TChangeContext; AFieldName,AOldValue,ANewValue: string): boolean;
const OPNAME = 'TOutputComparisonReservoirValidator.StudyDataHasChanged';
begin
...
function TOutputComparisonReservoirValidator.StudyHasChanged: boolean;
const OPNAME = 'TOutputComparisonReservoirValidator.StudyHasChanged';
begin
...
function TOutputComparisonReservoirValidator.LanguageHasChanged: boolean;
const OPNAME = 'TOutputComparisonReservoirValidator.LanguageHasChanged';
begin
  Result := False;
  try
    TabShetCaption := FAppModules.Language.GetString('TabCaption.OutputComparisonReservoir');
    Result := inherited LanguageHasChanged;
  except on E: Exception do HandleError(E, OPNAME) end;
end;

function TOutputComparisonReservoirValidator.SaveState: boolean;
const OPNAME = 'TOutputComparisonReservoirValidator.SaveState';
begin
...
function TOutputComparisonReservoirValidator.ViewDialog : TOutputGraphDialog;
const OPNAME = 'TOutputComparisonReservoirValidator.ViewDialog';
begin
  Result := nil;
  try
...
function TOutputComparisonReservoirValidator.GetNextSignificantRecord(ASender: TObject;ACurrentRecord: integer): integer;
const OPNAME = 'TOutputComparisonReservoirValidator.GetNextSignificantRecord';
begin
  Result := 0;
  try
...
function TOutputComparisonReservoirValidator.GetPreviousSignificantRecord(ASender: TObject;ACurrentRecord: integer): integer;
const OPNAME = 'TOutputComparisonReservoirValidator.GetPreviousSignificantRecord';
begin
  Result := 0;
  try
    Result := ACurrentRecord  - 1;
...
procedure TOutputComparisonReservoirValidator.ClearDataViewer;
const OPNAME = 'TOutputComparisonReservoirValidator.ClearDataViewer';
begin
...
procedure TOutputComparisonReservoirValidator.PopulateDataViewer;
const OPNAME = 'TOutputComparisonReservoirValidator.PopulateDataViewer';
begin
...
procedure TOutputComparisonReservoirValidator.PopulateDialogSelectors;
const OPNAME = 'TOutputComparisonReservoirValidator.PopulateDialogSelectors';
var
  LViewData    : string;
begin
  try
...
procedure TOutputComparisonReservoirValidator.RePopulateDataViewer;
const OPNAME = 'TOutputComparisonReservoirValidator.RePopulateDataViewer';
var
          ...
          begin
            ...
            begin
              ...
              begin
                ...
                LElements := LElements + LOutputComparisonData.ReservoirCount;
              end;
              ...
              begin
                LOutputComparisonData := LOutputComparisonList.GetOutputComparisonDataByIndex(LIndex);
                LReservoirsList := TStringList.Create;
                try
                  LReservoirsList.CommaText := LOutputComparisonData.ReservoirList;
                  for LRIndex := 0 to LReservoirsList.Count-1 do
                  begin
                    if LOutputComparisonData.OutputData.CastSummaryOutputData.GetBlockData(LDataContainer,
                      btMonthEndReservoirVolume,strToInt(LReservoirsList[LRIndex]),LErrors) then
                    begin
                      LReservoirData  := TYieldModelDataObject(FAppModules.Model.ModelData).NetworkElementData.ReservoirList.
                                         ReservoirByIdentifier[strToInt(LReservoirsList[LRIndex])];
                      LSeriesName := LOutputComparisonData.OutputFileName+ ' - '+LReservoirData.ReservoirConfigurationData.ReservoirName;
                      PopulateReservoirVolumeData(LCount,LDataContainer,LSeriesName);
                      inc(LCount);
                    end;
                  end;
                finally
                  LReservoirsList.Free;
                end;
              end;
              FomartMonthlyChart;
            end
...
procedure TOutputComparisonReservoirValidator.SetCurrentViewData;
const OPNAME = 'TOutputComparisonReservoirValidator.SetCurrentViewData';
var
  LIndex: integer;
begin
  try
...
procedure TOutputComparisonReservoirValidator.OnViewDataTypeChange(Sender: TObject);
const OPNAME = 'TOutputComparisonReservoirValidator.OnViewDataTypeChange';
begin
  try
    SetCurrentViewData;
    RePopulateDataViewer;
...
procedure TOutputComparisonReservoirValidator.ClearChart;
const OPNAME = 'TOutputComparisonReservoirValidator.ClearChart';
begin
  try
...
function TOutputComparisonReservoirValidator.ElementName: string;
const OPNAME = 'TOutputComparisonReservoirValidator.ElementName';
begin
  Result := '';
  try
  except on E: Exception do HandleError(E, OPNAME) end;
...
procedure TOutputComparisonReservoirValidator.PopulateReservoirVolumeData(ASeries : integer; AData: TStrings;ASeriesName : string);
const OPNAME = 'TOutputComparisonReservoirValidator.PopulateReservoirVolumeData';
var
...
procedure TOutputComparisonReservoirValidator.FomartMonthlyChart;
const OPNAME = 'TOutputComparisonReservoirValidator.FomartMonthlyChart';
var
  LFactor : double;
  LIndex : integer;
  LMax : double;
...
procedure TOutputComparisonReservoirValidator.GetChartLegend(AChart: TFieldChart);
const OPNAME = 'TOutputComparisonReservoirValidator.GetChartLegend';
var
  LIndex : integer;
  LTitle : string;
begin
...
procedure TOutputComparisonReservoirValidator.OnBtnDataSelectionClick(Sender: TObject);
const OPNAME = 'TOutputComparisonReservoirValidator.OnBtnDataSelectionClick';
begin
  try
    TYieldModelDataObject(FAppModules.Model.ModelData).OutputData.ShowDataSelectionDialog(FIdentifier,FNetworkElementType,osdComparisonReservoir,FCurrentViewData,FValueType);
  except on E: Exception do HandleError(E, OPNAME) end;
end;

procedure TOutputComparisonReservoirValidator.GetSelectionData;
const OPNAME = 'TOutputComparisonReservoirValidator.GetSelectionData';
var
...
procedure TOutputComparisonReservoirValidator.DoOnDataChange(Sender: TObject);
const OPNAME = 'TOutputComparisonReservoirValidator.DoOnDataChange';
var
...
procedure TOutputComparisonReservoirValidator.SetChartLegend(ALegendAlignment: TLegendAlignment; ALegendVisible: boolean);
const OPNAME = 'TOutputComparisonReservoirValidator.SetChartLegend';
begin
  try
